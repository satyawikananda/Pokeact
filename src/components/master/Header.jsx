        ...
        <>
            <div className="container mx-auto flex p-5 flex-col md:flex-row justify-center items-center">
                ...
                <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                    <button className="inline-flex w-1/4 h-1/5 p-10 items-start justify-evenly bg-gray-200 border-0 py-1 px-3 ml-2 focus:outline-none hover:bg-gray-300 rounded text-base mt-4 md:mt-0">Code
